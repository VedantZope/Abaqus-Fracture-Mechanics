...
filename = "odb_directory.py"  # Replace with your file name
...
session.printToFile(fileName='Deformed Model', format=TIFF, canvasObjects=(
    session.viewports['Viewport: 1'], ))
#working directory
odb = session.odbs[working_directory]
...
session.printToFile(fileName='F-D Curve', format=TIFF, canvasObjects=(
    session.viewports['Viewport: 1'], ))
...
session.writeXYReport(fileName='F-D data'+'.txt', appendMode=OFF, xyData=(x0, x1))
