...
if __name__ == '__main__':
    ...
    for generation in range(100):
        ...
        #best_in_generation is just passing parameters, so i will pass this to my model and then after
        #getting the simulation results F-D data as txt file, we will assign it to new_x and new_y
